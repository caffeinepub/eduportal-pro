      ...
      >
        ...
        <div className="flex items-center justify-center gap-3 flex-wrap">
          <button
            type="button"
            onClick={() => navigate("register")}
            className="px-8 py-3 bg-white text-purple-700 rounded-xl font-semibold text-lg hover:bg-purple-50 transition-colors shadow-lg"
          >
            Get Started
          </button>
          <button
        ...
        <img
          ...
          className="w-full max-w-4xl mx-auto rounded-2xl shadow-2xl mt-8 object-cover"
      ...
      <section className="py-12 px-6 bg-slate-50 text-center">
        ...
        <div className="flex items-center justify-center gap-3 flex-wrap">
          ...
          <button
            type="button"
            onClick={() => navigate("login")}
            className="px-8 py-3 border border-purple-600 text-purple-600 rounded-xl font-semibold hover:bg-purple-50 transition-colors"
          >
            Sign In
          </button>
        </div>
